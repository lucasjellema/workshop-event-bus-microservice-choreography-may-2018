...
var redisHost = process.env.REDIS_HOST || "192.168.99.111";
var redisPort = process.env.REDIS_PORT || 38789;
...
if (!callViaAPI) {try { redisClient = Redis.createClient({ "host": redisHost, "port": redisPort })}catch (err){console.log("Exception in Redis Client "+err)}};
